...
ถ้ายังไม่เข้าใจโจทย์ทั้งหมด ให้เขียนสิ่งที่เข้าใจในตอนนี้ ความเข้าใจอาจยังไม่ครบหรืออาจผิดได้ แต่ต้องพยายามอธิบายอย่างจริงใจ
    ...
    รับค่าที่ข้อความเป็น str
    โจทย์ต้องการ output ที่ข้อความกลับด้านตัวเล็ก
...
สามารถเขียนเป็น pseudocode, flowchart idea หรือขั้นตอนความคิดได้
    ...
    Step 1:รับค่า str ใส่ตัวแปร name แล้วแปลงเป็น.lower
    Step 2:print ตัวแปร name โดยใช้ string Slicing เพื่มค่าทีละ -1
...
ทำไมเลือก case นี้:
```text
    อยากรู้ว่าถ้ามีตัวเลขจะเป็นยังไง
```
Input:
```text
    Lnwza007
