...
```text
    รับค่าอาหารทั้งหมดมา แล้วนำมาบวกกับ service charge จากนั้นค่อยรวมกับ vat ของค่าอาหารทั้งหมด โดยขั้นต่ำของ service charge
    คือ 50 และมากสุดคือ 1000
    แล้วคำนวน จากนั้น print ค่าที่เปป็นทศนิยม 2 ตำแหน่ง
```
...
```text
    Step 1:รับค่าอาหาร
    Step 2:เช็คค่า service charge ก่อนว่าน้อยกว่าหรือสูงกว่าที่กำหนดไหม
    Step 3:หาค่า vat ก่อน
    Step 4:รวมทุกค่าเข้าด้วยกัน
    Step 5:print ค่าที่ต้องชำระเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
    เหมือนกัน เพราะเราต้องหาค่าแต่ละอย่างก่อนถึงค่อยเอามารวมกัน
```
