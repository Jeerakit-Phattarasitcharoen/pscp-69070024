...
```text
รับจะนวนจริงมาแล้วแปลงค่่านั้นเป็นอีกค่าหนึ่งจากสูตร
Input:
รับหน่วยองศาแรก
รับหน่วยองศาสอง

Output:
แปลงเลขจากองศาหนึ่งไปองศาสอง

Constraints:
input เป็น float และ print เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับค่า float มา
Step 2: กำหนดค่า celsius ไว้สำหรับหาตัวอื่น
Step 3: เช็คว่าตัวแรกคือหน่วยอะไร
Step 4: แปลงหน่วยแรกให้เป็น celsius
Step 5: เช็คหน่วยสอง
Step 6: แปลงจาก celsius เป็นหน่วยที่ต้องการ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้ match case ในการเช็คว่าเข้า case ไหนจากนั้นก็แปลงค่าตามสูตรจนได้ผลลับ
```
