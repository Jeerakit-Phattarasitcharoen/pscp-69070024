...
```text
โจทย์ให้เช็คว่าคนที่โหวตคะแนนสูงสุดกับต่างสุดห่างกันมากมั้ย
Input:
รับ score ทั้งหมด
รับค่าโหวตที่มากที่สุด

Output:
ถ้าคะแนนโหวตสูงสุดกับต่างสุดห่างกันเกิน 2 ให้ print surprising ถ้าไม่ให้ print Not surprising

Constraints:
เราไม่รู้ว่าคนที่ 2 กับ 3 โหวตกี่คะแนน เพราะฉะนั้นเราตีว่า คนที่ 1 กับ 2 โหวตเท่ากันแล้วหาคนที่ 3 
```
...
```text
Step 1: รับ sum score
Step 2: รับ high score
Step 3: ถ้า score หารด้วย high score สองรอบแล้ว มากกว่า 2 ป่าว
Step 4: ถ้าจริง print Surprising
Step 5: ถ้าไม่ print Not Surprising
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่มีการเพื่มการเช็คว่า คะแนน total ที่ได้จากการหาร ต่ำกว่า 0 หรือป่าวถ้าต่ำกว่าให้เป็น 0 ไปเลย
```
...
```text
เช็คว่าถ้า total = 0 จะเป็นยังไง
```
...
```text
บอกว่าถ้าติดลบจะเป็นยังไง
```

คุณยังทำอะไรด้วยตนเอง

```text
เพื่อตัวเช็คค่าติดลบไปถ้าติดให้เป็น 0
```
