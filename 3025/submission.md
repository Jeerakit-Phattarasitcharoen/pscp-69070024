...
```text
รับค่าเป็นเดือนกับวันที่ ถ้าวันที่ตั้งแต่ 21 ขึ้นไปแล้ว 3 หารลงตัว ให้เปลี่ยนเป็น season ถัดไป ถ้าไม่ก็print season เดิม
```
...
Step 2: ตรวจว่ามากกว่า 21 หรือป่าว
Step 3: ถ้าจริง เช็คว่เดือนหาร 3 ลงตัวป่าว
Step 3.1: ถ้าจริง เปลื่ยนไป print เดือนถัดเไป
Step 4: ถ้าไม่จริง print เดือนตามปรกติ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยได้สร้าง dict เก็บค่าทุกเดือนไว้ก่อนแล้วมาเช็ควันถ้าวันเกินก็เรียกเดือนที่หาร 3 ลงตัว มาเปลี่ยนเป็น season ใหม่
```
...
```text
ตรวจว่าถ้าวันเกินเดือนปกติจะขึ้นเดือนใหม่ไหม
```
...
```text
เช็คว่าถ้าไม่มีค่าใน dict จะเป็นยังไง
```
