...
```text
ให้รับค่าจำนวนเต็มบวกแล้วหารสิบไปเรื่อยๆจนถึง 0
Input:
รับค่าจำนวนเต็มบวก

Output:
ปริ้นค่าที่รับมาแล้วหาร 10 จนถึง 0

Constraints:
เค้าบอกมาแล้วว่าเป็นจำนวนเต็มบวกจริงๆไม่ต้องกังวล 0 กับ ติดลบ
```
...
```text
Step 1: รับค่า N
Step 2: สร้าง list ว่างมาไว้้เก็บค่า
Step 3: แล้วให้ loop ลบที่ละ 1 จนกว่าจะเข้าเงื่อนไข
Step 4: ถ้า N % 10 แล้วได้ 0 ให้ใส่ใน list
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้ modulo เพื่อตรวจเศษเมื่อ N หารด้วย 10 แล้ว = 0 แสดงว่าหารลงตัว
```
...
```text
ต้องเช็คว่าโค้ดจัดการ 0 ได้ไหม
```
...
```text
เช็คว่าถ้าหารไม่ได้จะ print ยังไง
```
