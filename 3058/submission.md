...
```text
ให้หาว่าถ้านำอิฐก้อนใหญ่มาต่อสะพานแบบน้อยที่สุด จะต้องใช้อิฐก้อนเล็กอีกกี่ก้อน

input: จำนวนอิฐก้อนใหญ่ จำนวนอิฐก้อนเล็ก ระยะทางที่ต้องต่อทั้งหมด

output:จำนวนอิฐก้อนเล็กที่ต้องใช้

constraints:ถ้าอิฐเล็กไม่พอให้แสดง -1
```
...
```text
รับค่า big, small, goalStep 1: รับค่า จำนวนอิฐใหญ่ อิฐเล็ก และระยะทางที่ต้องต่อ
Step 2: หาจำนวนอิฐใหญ่ที่ใช้ โดยเอาระยะทางหาร 5
Step 3: ถ้าอิฐใหญ่ที่ต้องใช้ มากกว่าจำนวนที่มี ให้ใช้เท่าที่มี
Step 4: คำนวณระยะที่เหลือ หลังจากใช้อิฐใหญ่
Step 5: ถ้าอิฐเล็ก พอเติมระยะที่เหลือ ให้แสดงจำนวนอิฐเล็กที่ต้องใช้
Step 6: ถ้าอิฐเล็ก ไม่พอ ให้แสดง -1
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้การเลือกอิฐก้อนใหญ่ให้ได้มากที่สุดก่อน แล้วคำนวณระยะที่เหลือเพื่อเติมด้วยอิฐก้อนเล็ก
```
...
```text
ใช้อิฐก้อนใหญ่หมดแล้ว ใช้ก่อนเล็กต่อ
```
