...
```text
ให้หาว่าระหว่าง a-b มีกี่จำนวนที่หารด้วย d แล้วเหลือเศษ r

input:ค่าเริ่มต้น a , จบ b ค่าที่นำมาหาร d เศษที่ต้องการ r

output:จำนวนเลขระหว่าง a ถึง b ที่หารด้วย d แล้วเหลือเศษ r
```
...
Step 2: ประกาศค่า count ไว้นับ
Step 3: ให้ loop ถ้า i หารแล้วเศษเท่ากับ r ให้ count +1
Step 4: print count
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ให้ loop ตั้งแต่ a ถึง b แล้วให้เช็คว่า i % d == r หรือป่าวถ้าใช้ให้นับ
```
...
```text
เช็คจำนวนที่หารด้วย d แล้วเหลือเศษ r ว่าคิดตรงไหม
```
...
```text
เช็ตเวลาจำนวนที่ตรงตามเงื่อนไข
```
