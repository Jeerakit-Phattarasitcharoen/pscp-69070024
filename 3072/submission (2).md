...
```text
หาว่าในค่าที่รับมามีสระกี่ตัว

input: มาประโยคหนึ่ง

output: จำนวนสระ

constraints: output จะต้องprint สระกับจำนวน a e i o u
```
...
```text
Step 1: รับข้อความมา 1 ค่า และเปลี่ยนตัวอักษรทั้งหมดเป็นตัวพิมพ์เล็ก
Step 2: สร้าง List เก็บสระ a, e, i, o, u
Step 3: สร้าง List count เพื่อเก็บจำนวนของสระแต่ละตัว
Step 4: ตรวจสอบตัวอักษรในข้อความทีละตัว ถ้าเป็นสระให้เพิ่มจำนวนใน count
Step 5: print สระที่พบ พร้อมจำนวนของสระนั้น
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ให้เช็คว่ามีสระตรงใน list ไหม ถ้าตรงก็ไปบวก count ที่ตรงกับสระนั้น
```
