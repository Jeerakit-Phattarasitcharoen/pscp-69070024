...
```text
โจทย์ให้คำนวณราคาค่าบริการขนส่งตามตารางที่กำหนดให้

input: รับค่าต้นทางและปลายทางและน้ำหนัก
output: ราคาค่าใช้จ่ายหลังจากคำนวณแล้ว
constraints: ถ้าจุดstart กับ end ไม่อยู่ในตารางจะต้องได้ Error
```
...
```text
Step 1: รับค่าต้นทางและปลายทาง
Step 2: รับค่าน้ำหนักพัสดุ
Step 3: ตรวจสอบว่าต้นทางและปลายทางตรงกับเส้นทางที่กำหนดหรือไม่
Step 4: เลือกค่าราคาคงที่และราคาต่อกิโลกรัมตามเส้นทาง
Step 5: คำนวณราคารวมจาก ราคาคงที่ + (น้ำหนัก × ราคาต่อกิโลกรัม)
Step 6: แสดงราคารวมเป็นทศนิยม 2 ตำแหน่ง
Step 7: ถ้าไม่มีเส้นทางที่ตรงกับต้นทางและปลายทาง ให้แสดง "Error"
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยไล่เช็คไปว่าเข้าเงื่อนไขไหน
```
