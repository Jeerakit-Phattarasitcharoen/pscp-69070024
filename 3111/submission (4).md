...
```text
โจทย์ให้คนนวณราคาที่ต้องจ่าย
input: 
1.รับว่าเป็นสมาชิกไหม
2.รับจำนวนสินค้า
3.ราคาต่อชิ้น
output:
ราคาที่ต้องจ่าย
constraints:
ถ้าเป็นสมาชิกลด 5 % ถ้าไม่และราคาเกิน 500 ลด 3%
```
...
```text
Step 1: input ว่าเป็นสมาชิกไหม
Step 2: input รับจำนวนสินค้า
Step 3: input ราคาสินค้า
Step 4: ถ้าเป็นสมาชิกราคาจะลด 5%
Step 5: ถ้าไม่ได้เป็นสมาชิกและราคาสินค้าเกิน 500 ลด3%
Step 6: print ราคาที่ต้องจ่ายแล้วปัดเศษ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก โดยใช้ math ceil ในการปัดเศษขึ้นก่อนที่จะ print เป็นทศนิยม 2 ตำแหน่ง
```
...
```text
เช็คว่าไม่เป็นสมาชิกได้และต่ำกว่า 500 ได้เท่าไร
```
